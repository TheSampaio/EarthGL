...
void Sandbox::OnStart()
{
    ...
    mEarthBathy = new Texture(PROJECT_RESOURCE_DIR "texture/diffuse-earth-bathy-4k.jpg", GL_RGB, GL_TEXTURE0);
    mEarthShallow = new Texture(PROJECT_RESOURCE_DIR "texture/diffuse-earth-shallow-4k.jpg", GL_RGB, GL_TEXTURE1);
    mEarthClouds = new Texture(PROJECT_RESOURCE_DIR "texture/diffuse-earth-clouds-2k.jpg", GL_RGB, GL_TEXTURE2);
